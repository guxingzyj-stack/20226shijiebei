...
export type ScriptOverview = {
  ...
  all_direction_hits?: number;
  all_exact_hits?: number;
  all_direction_accuracy?: number | null;
  all_exact_accuracy?: number | null;
  real_count?: number;
  real_direction_hits?: number;
  real_exact_hits?: number;
  real_direction_accuracy?: number | null;
  real_exact_accuracy?: number | null;
  script_count?: number;
  script_direction_hits?: number;
  script_exact_hits?: number;
  script_direction_accuracy?: number | null;
  script_exact_accuracy?: number | null;
...
export type ScriptMatchItem = {
  ...
  is_real?: boolean;
  sample_type?: "known_result_seed" | "script_projection" | string;
